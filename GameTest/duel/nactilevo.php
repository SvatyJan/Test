...
// L1 STATS
				...
				$dotaz1 = "SELECT * FROM game_stats WHERE username='$player1' LIMIT 1";
				...
				if (mysqli_num_rows($result1) > 0) {
					while ($row = mysqli_fetch_assoc($result1)) {						
						...
						// L1 ITEMS
						$dotaz2 = "SELECT * FROM game_items WHERE username='$player1' AND equiped=1";
				...
				// L1 SPELLS
				$dotaz3 = "SELECT * FROM game_spellbar WHERE username='$player1' LIMIT 1";
